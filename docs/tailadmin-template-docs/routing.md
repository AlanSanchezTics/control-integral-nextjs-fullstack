...
|-------|--------|---------|
| `admin` | `src/app/(admin)` | Admin dashboard pages with sidebar + header layout |
| `auth` | `src/app/(full-width-pages)/(auth)` | Authentication pages and auth-specific split layout |
| `chart` | `src/app/(admin)/(others-pages)/(chart)` | Chart route subgroup (bar/line) |
| `error-pages` | `src/app/(full-width-pages)/(error-pages)` | Error/status pages rendered in full-width layout |
| `forms` | `src/app/(admin)/(others-pages)/(forms)` | Form route subgroup |
| `full-width-pages` | `src/app/(full-width-pages)` | Pages without admin shell (no sidebar/header) |
| `others-pages` | `src/app/(admin)/(others-pages)` | Admin sub-group for charts, forms, tables, calendar, profile pages |
| `tables` | `src/app/(admin)/(others-pages)/(tables)` | Table route subgroup |
| `ui-elements` | `src/app/(admin)/(ui-elements)` | Admin sub-group for UI showcase pages |
...
| `/alerts` | `src/app/(admin)/(ui-elements)/alerts/page.tsx` | `admin`, `ui-elements` |
| `/avatars` | `src/app/(admin)/(ui-elements)/avatars/page.tsx` | `admin`, `ui-elements` |
| `/badge` | `src/app/(admin)/(ui-elements)/badge/page.tsx` | `admin`, `ui-elements` |
| `/bar-chart` | `src/app/(admin)/(others-pages)/(chart)/bar-chart/page.tsx` | `admin`, `others-pages`, `chart` |
| `/basic-tables` | `src/app/(admin)/(others-pages)/(tables)/basic-tables/page.tsx` | `admin`, `others-pages`, `tables` |
| `/blank` | `src/app/(admin)/(others-pages)/blank/page.tsx` | `admin`, `others-pages` |
| `/buttons` | `src/app/(admin)/(ui-elements)/buttons/page.tsx` | `admin`, `ui-elements` |
| `/calendar` | `src/app/(admin)/(others-pages)/calendar/page.tsx` | `admin`, `others-pages` |
| `/error-404` | `src/app/(full-width-pages)/(error-pages)/error-404/page.tsx` | `full-width-pages`, `error-pages` |
| `/form-elements` | `src/app/(admin)/(others-pages)/(forms)/form-elements/page.tsx` | `admin`, `others-pages`, `forms` |
| `/images` | `src/app/(admin)/(ui-elements)/images/page.tsx` | `admin`, `ui-elements` |
| `/line-chart` | `src/app/(admin)/(others-pages)/(chart)/line-chart/page.tsx` | `admin`, `others-pages`, `chart` |
| `/modals` | `src/app/(admin)/(ui-elements)/modals/page.tsx` | `admin`, `ui-elements` |
| `/profile` | `src/app/(admin)/(others-pages)/profile/page.tsx` | `admin`, `others-pages` |
| `/signin` | `src/app/(full-width-pages)/(auth)/signin/page.tsx` | `full-width-pages`, `auth` |
| `/signup` | `src/app/(full-width-pages)/(auth)/signup/page.tsx` | `full-width-pages`, `auth` |
| `/videos` | `src/app/(admin)/(ui-elements)/videos/page.tsx` | `admin`, `ui-elements` |
...
| `/alerts` | `src/app/layout.tsx` → `src/app/(admin)/layout.tsx` |
| `/avatars` | `src/app/layout.tsx` → `src/app/(admin)/layout.tsx` |
| `/badge` | `src/app/layout.tsx` → `src/app/(admin)/layout.tsx` |
| `/bar-chart` | `src/app/layout.tsx` → `src/app/(admin)/layout.tsx` |
| `/basic-tables` | `src/app/layout.tsx` → `src/app/(admin)/layout.tsx` |
| `/blank` | `src/app/layout.tsx` → `src/app/(admin)/layout.tsx` |
| `/buttons` | `src/app/layout.tsx` → `src/app/(admin)/layout.tsx` |
| `/calendar` | `src/app/layout.tsx` → `src/app/(admin)/layout.tsx` |
| `/error-404` | `src/app/layout.tsx` → `src/app/(full-width-pages)/layout.tsx` |
| `/form-elements` | `src/app/layout.tsx` → `src/app/(admin)/layout.tsx` |
| `/images` | `src/app/layout.tsx` → `src/app/(admin)/layout.tsx` |
| `/line-chart` | `src/app/layout.tsx` → `src/app/(admin)/layout.tsx` |
| `/modals` | `src/app/layout.tsx` → `src/app/(admin)/layout.tsx` |
| `/profile` | `src/app/layout.tsx` → `src/app/(admin)/layout.tsx` |
| `/signin` | `src/app/layout.tsx` → `src/app/(full-width-pages)/layout.tsx` → `src/app/(full-width-pages)/(auth)/layout.tsx` |
| `/signup` | `src/app/layout.tsx` → `src/app/(full-width-pages)/layout.tsx` → `src/app/(full-width-pages)/(auth)/layout.tsx` |
| `/videos` | `src/app/layout.tsx` → `src/app/(admin)/layout.tsx` |
...
- `/error-404` → `src/app/(full-width-pages)/(error-pages)/error-404/page.tsx`
